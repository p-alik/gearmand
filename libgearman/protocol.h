...
typedef enum
{
  ...
  GEARMAN_COMMAND_SUBMIT_REDUCE_JOB,          /* C->J: MAP[0]REDUCER[0]UNIQ[0]PRIORITY[0]ARGS */
  GEARMAN_COMMAND_SUBMIT_REDUCE_JOB_BACKGROUND,          /* C->J: MAP[0]UNIQ[0]REDUCER[0]PRIORITY[0]ARGS */
