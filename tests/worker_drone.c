...
test_return clone_test(void *object)
{
  gearman_universal_st *param= (gearman_universal_st *)object;
...
void destroy(void *object)
{
  gearman_universal_st *ptr= (gearman_universal_st *)object;
